...
<footer class="bg-gray-900 text-gray-300 mt-16 py-12">
    ...
    <div class="gk-footer-inner mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 pb-8">
        <div>
        ...
        <div class="flex items-center gap-4 mt-4 md:mt-0">
            @foreach($socialLinks as $link)
                <a href="{{ $link['url'] }}" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition">
