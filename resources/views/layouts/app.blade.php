...
<body class="antialiased">
    ...
    <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp') }}?text={{ urlencode(\App\Models\Setting::get('whatsapp_message') ?: __('general.whatsapp_message')) }}" target="_blank" rel="noopener" class="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-3.5 rounded-full shadow-lg hover:scale-110 transition z-50" title="Chat on WhatsApp">
