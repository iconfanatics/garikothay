...
class AnnouncementPolicy
{
     ...
     */
    public function view(\Illuminate\Foundation\Auth\User $user, Announcement $announcement): bool
    {
     ...
     */
    public function update(\Illuminate\Foundation\Auth\User $user, Announcement $announcement): bool
    {
     ...
     */
    public function delete(\Illuminate\Foundation\Auth\User $user, Announcement $announcement): bool
    {
     ...
     */
    public function forceDelete(\Illuminate\Foundation\Auth\User $user, Announcement $announcement): bool
    {
     ...
     */
    public function restore(\Illuminate\Foundation\Auth\User $user, Announcement $announcement): bool
    {
     ...
     */
    public function replicate(\Illuminate\Foundation\Auth\User $user, Announcement $announcement): bool
    {
