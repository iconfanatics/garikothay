...
class OrderPolicy
{
     ...
     */
    public function view(\Illuminate\Foundation\Auth\User $user, Order $order): bool
    {
     ...
     */
    public function update(\Illuminate\Foundation\Auth\User $user, Order $order): bool
    {
     ...
     */
    public function delete(\Illuminate\Foundation\Auth\User $user, Order $order): bool
    {
     ...
     */
    public function forceDelete(\Illuminate\Foundation\Auth\User $user, Order $order): bool
    {
     ...
     */
    public function restore(\Illuminate\Foundation\Auth\User $user, Order $order): bool
    {
     ...
     */
    public function replicate(\Illuminate\Foundation\Auth\User $user, Order $order): bool
    {
