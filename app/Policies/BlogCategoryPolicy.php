...
class BlogCategoryPolicy
{
     ...
     */
    public function view(\Illuminate\Foundation\Auth\User $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function update(\Illuminate\Foundation\Auth\User $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function delete(\Illuminate\Foundation\Auth\User $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function forceDelete(\Illuminate\Foundation\Auth\User $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function restore(\Illuminate\Foundation\Auth\User $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function replicate(\Illuminate\Foundation\Auth\User $user, BlogCategory $blogCategory): bool
    {
