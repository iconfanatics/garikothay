...
class BlogCategoryPolicy
{
     ...
     */
    public function view(Admin $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function update(Admin $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function delete(Admin $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function forceDelete(Admin $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function restore(Admin $user, BlogCategory $blogCategory): bool
    {
     ...
     */
    public function replicate(Admin $user, BlogCategory $blogCategory): bool
    {
