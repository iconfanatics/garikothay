...
class CartPolicy
{
     ...
     */
    public function view(\Illuminate\Foundation\Auth\User $user, Cart $cart): bool
    {
     ...
     */
    public function update(\Illuminate\Foundation\Auth\User $user, Cart $cart): bool
    {
     ...
     */
    public function delete(\Illuminate\Foundation\Auth\User $user, Cart $cart): bool
    {
     ...
     */
    public function forceDelete(\Illuminate\Foundation\Auth\User $user, Cart $cart): bool
    {
     ...
     */
    public function restore(\Illuminate\Foundation\Auth\User $user, Cart $cart): bool
    {
     ...
     */
    public function replicate(\Illuminate\Foundation\Auth\User $user, Cart $cart): bool
    {
