...
class PagePolicy
{
     ...
     */
    public function view(Admin $user, Page $page): bool
    {
     ...
     */
    public function forceDelete(Admin $user, Page $page): bool
    {
     ...
     */
    public function restore(Admin $user, Page $page): bool
    {
     ...
     */
    public function replicate(Admin $user, Page $page): bool
    {
