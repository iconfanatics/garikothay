...
class PaymentGatewayPolicy
{
     ...
     */
    public function view(\Illuminate\Foundation\Auth\User $user, PaymentGateway $paymentGateway): bool
    {
     ...
     */
    public function update(\Illuminate\Foundation\Auth\User $user, PaymentGateway $paymentGateway): bool
    {
     ...
     */
    public function delete(\Illuminate\Foundation\Auth\User $user, PaymentGateway $paymentGateway): bool
    {
     ...
     */
    public function forceDelete(\Illuminate\Foundation\Auth\User $user, PaymentGateway $paymentGateway): bool
    {
     ...
     */
    public function restore(\Illuminate\Foundation\Auth\User $user, PaymentGateway $paymentGateway): bool
    {
     ...
     */
    public function replicate(\Illuminate\Foundation\Auth\User $user, PaymentGateway $paymentGateway): bool
    {
