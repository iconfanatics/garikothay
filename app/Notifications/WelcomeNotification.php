...
class WelcomeNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Welcome to ' . \App\Models\Setting::get('site_name', 'Garikothay') . '! 💻')
            ->greeting("Welcome, {$notifiable->name}! 💻")
            ->line('Thank you for joining ' . \App\Models\Setting::get('site_name', 'Garikothay') . ' — ' . \App\Models\Setting::get('site_tagline', 'Your Ultimate Destination for Premium Computer Accessories') . '.')
