        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Contact')->schema([
                    Forms\Components\TextInput::make('phone')->label('Sales Phone'),
                    Forms\Components\TextInput::make('phone_2')->label('Support Phone (Optional)'),
                    Forms\Components\TextInput::make('phone_3')->label('Corporate Phone (Optional)'),
