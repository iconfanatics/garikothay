        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Contact')->schema([
                    Forms\Components\TextInput::make('phone')->label('Phone 1')->rule(new \App\Rules\BdPhone()),
                    Forms\Components\TextInput::make('phone_2')->label('Phone 2 (Optional)')->rule(new \App\Rules\BdPhone()),
                    Forms\Components\TextInput::make('phone_3')->label('Phone 3 (Optional)')->rule(new \App\Rules\BdPhone()),
                    ...
                    Forms\Components\TextInput::make('email')->label('Email 1')->email(),
                    Forms\Components\TextInput::make('email_2')->label('Email 2 (Optional)')->email(),
                    Forms\Components\TextInput::make('email_3')->label('Email 3 (Optional)')->email(),
