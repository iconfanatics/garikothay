...
class Supplier extends Model
{
    ...
    protected $fillable = [
        ...
        'bank_details', 'personal_mobile_banking_provider', 'personal_mobile_banking_number',
        'merchant_mobile_banking_provider', 'merchant_mobile_banking_number', 'mobile_banking_provider', 'mobile_banking_number',
